...
//Dạ em chào thầy, em là Thuận - 18521468 đại diện nhóm quay video demo
//về ứng dụng chat (giống Messenger)
//Em sẽ tiến hành tạo tài khoản và nhắn tin ạ
//Em mở 2 tab để demo nhắn tin ạ
//EM sẽ tiến hành tìm kiếm để nhắn tin
//Em sẽ tiến hành demo chức năng quên mật khẩu
//Dạ phần demo của nhóm đã xong ạ. Em cảm ơn thầy và các bạn đã xem ^^
